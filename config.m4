...
if test "$PHP_GEOMETRY" = "yes"; then
  ...
  PHP_NEW_EXTENSION(geometry, geometry.c coordinate.c coordinate_set.c distance_map.c helmert.c task.c string_manip.c statistics/*.c formatter/formatter_*.c include/json/*.c, $ext_shared)
fi
